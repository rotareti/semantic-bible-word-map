...
if __name__ == '__main__':
    ...
    # Train Skip-gram model with 100 dimensions, window=5, min_count=2, epochs=15
    model = Word2Vec(sentences=sentences, vector_size=100, window=5, min_count=2, workers=4, sg=1, epochs=15)
