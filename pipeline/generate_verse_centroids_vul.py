...
def main():
    ...
    print("Step 4: Generating Verse Centroids and Cross-Reference Map for Latin Vulgate...")

    verse_index_path = 'data/output/verse_index_vul.json'
    wordmap_path = 'data/output/wordmap_2d_vul.json'
    output_path = 'data/output/versemap_2d_vul.json'
    ...
    STOPWORDS = {
        ...
        'themself', 'themselves', 'myself', 'yourself', 'himself', 'herself'
    }
