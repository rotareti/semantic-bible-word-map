...
BIBLE_BOOKS = [
    ...
    {"code": "1ES", "name": "1 Esdras", "testament": "OT", "genre": "Deuterocanon", "order": 15},
    {"code": "EZR", "name": "Ezra", "testament": "OT", "genre": "History", "order": 16},
    {"code": "NEH", "name": "Nehemiah", "testament": "OT", "genre": "History", "order": 17},
    {"code": "TOB", "name": "Tobit", "testament": "OT", "genre": "Deuterocanon", "order": 18},
    {"code": "JDT", "name": "Judith", "testament": "OT", "genre": "Deuterocanon", "order": 19},
    {"code": "EST", "name": "Esther", "testament": "OT", "genre": "History", "order": 20},
    {"code": "1MA", "name": "1 Maccabees", "testament": "OT", "genre": "Deuterocanon", "order": 21},
    {"code": "2MA", "name": "2 Maccabees", "testament": "OT", "genre": "Deuterocanon", "order": 22},
    {"code": "3MA", "name": "3 Maccabees", "testament": "OT", "genre": "Deuterocanon", "order": 23},
    {"code": "4MA", "name": "4 Maccabees", "testament": "OT", "genre": "Deuterocanon", "order": 24},
    # Poetic & Wisdom Books (9)
    {"code": "JOB", "name": "Job", "testament": "OT", "genre": "Wisdom", "order": 25},
    {"code": "PSA", "name": "Psalms", "testament": "OT", "genre": "Wisdom", "order": 26},
    {"code": "ODA", "name": "Odes", "testament": "OT", "genre": "Deuterocanon", "order": 27},
    {"code": "PRO", "name": "Proverbs", "testament": "OT", "genre": "Wisdom", "order": 28},
    {"code": "ECC", "name": "Ecclesiastes", "testament": "OT", "genre": "Wisdom", "order": 29},
    {"code": "SNG", "name": "Song of Solomon", "testament": "OT", "genre": "Wisdom", "order": 30},
    {"code": "WIS", "name": "Wisdom of Solomon", "testament": "OT", "genre": "Deuterocanon", "order": 31},
    {"code": "SIR", "name": "Sirach", "testament": "OT", "genre": "Deuterocanon", "order": 32},
    {"code": "PSS", "name": "Psalms of Solomon", "testament": "OT", "genre": "Deuterocanon", "order": 33},
    # Minor Prophets (12)
    {"code": "HOS", "name": "Hosea", "testament": "OT", "genre": "Minor Prophets", "order": 34},
    {"code": "AMO", "name": "Amos", "testament": "OT", "genre": "Minor Prophets", "order": 35},
    {"code": "MIC", "name": "Micah", "testament": "OT", "genre": "Minor Prophets", "order": 36},
    {"code": "JOL", "name": "Joel", "testament": "OT", "genre": "Minor Prophets", "order": 37},
    ...
    {"code": "NAM", "name": "Nahum", "testament": "OT", "genre": "Minor Prophets", "order": 40},
    {"code": "HAB", "name": "Habakkuk", "testament": "OT", "genre": "Minor Prophets", "order": 41},
    {"code": "ZEP", "name": "Zephaniah", "testament": "OT", "genre": "Minor Prophets", "order": 42},
    {"code": "HAG", "name": "Haggai", "testament": "OT", "genre": "Minor Prophets", "order": 43},
    {"code": "ZEC", "name": "Zechariah", "testament": "OT", "genre": "Minor Prophets", "order": 44},
    {"code": "MAL", "name": "Malachi", "testament": "OT", "genre": "Minor Prophets", "order": 45},
    # Major Prophets & Additions (9)
    {"code": "ISA", "name": "Isaiah", "testament": "OT", "genre": "Major Prophets", "order": 46},
    {"code": "JER", "name": "Jeremiah", "testament": "OT", "genre": "Major Prophets", "order": 47},
    {"code": "BAR", "name": "Baruch", "testament": "OT", "genre": "Deuterocanon", "order": 48},
    {"code": "LAM", "name": "Lamentations", "testament": "OT", "genre": "Major Prophets", "order": 49},
    {"code": "LJE", "name": "Letter of Jeremiah", "testament": "OT", "genre": "Deuterocanon", "order": 50},
    {"code": "EZK", "name": "Ezekiel", "testament": "OT", "genre": "Major Prophets", "order": 51},
    {"code": "SUS", "name": "Susanna", "testament": "OT", "genre": "Deuterocanon", "order": 52},
    {"code": "DAN", "name": "Daniel", "testament": "OT", "genre": "Major Prophets", "order": 53},
    {"code": "BEL", "name": "Bel and the Dragon", "testament": "OT", "genre": "Deuterocanon", "order": 54},
    # New Testament (27)
    {"code": "MAT", "name": "Matthew", "testament": "NT", "genre": "Gospels", "order": 55},
    {"code": "MRK", "name": "Mark", "testament": "NT", "genre": "Gospels", "order": 56},
    {"code": "LUK", "name": "Luke", "testament": "NT", "genre": "Gospels", "order": 57},
    {"code": "JHN", "name": "John", "testament": "NT", "genre": "Gospels", "order": 58},
    {"code": "ACT", "name": "Acts", "testament": "NT", "genre": "History", "order": 59},
    {"code": "ROM", "name": "Romans", "testament": "NT", "genre": "Pauline Epistles", "order": 60},
    {"code": "1CO", "name": "1 Corinthians", "testament": "NT", "genre": "Pauline Epistles", "order": 61},
    {"code": "2CO", "name": "2 Corinthians", "testament": "NT", "genre": "Pauline Epistles", "order": 62},
    {"code": "GAL", "name": "Galatians", "testament": "NT", "genre": "Pauline Epistles", "order": 63},
    {"code": "EPH", "name": "Ephesians", "testament": "NT", "genre": "Pauline Epistles", "order": 64},
    {"code": "PHP", "name": "Philippians", "testament": "NT", "genre": "Pauline Epistles", "order": 65},
    {"code": "COL", "name": "Colossians", "testament": "NT", "genre": "Pauline Epistles", "order": 66},
    {"code": "1TH", "name": "1 Thessalonians", "testament": "NT", "genre": "Pauline Epistles", "order": 67},
    {"code": "2TH", "name": "2 Thessalonians", "testament": "NT", "genre": "Pauline Epistles", "order": 68},
    {"code": "1TI", "name": "1 Timothy", "testament": "NT", "genre": "Pauline Epistles", "order": 69},
    {"code": "2TI", "name": "2 Timothy", "testament": "NT", "genre": "Pauline Epistles", "order": 70},
    {"code": "TIT", "name": "Titus", "testament": "NT", "genre": "Pauline Epistles", "order": 71},
    {"code": "PHM", "name": "Philemon", "testament": "NT", "genre": "Pauline Epistles", "order": 72},
    {"code": "HEB", "name": "Hebrews", "testament": "NT", "genre": "General Epistles", "order": 73},
    {"code": "JAS", "name": "James", "testament": "NT", "genre": "General Epistles", "order": 74},
    {"code": "1PE", "name": "1 Peter", "testament": "NT", "genre": "General Epistles", "order": 75},
    {"code": "2PE", "name": "2 Peter", "testament": "NT", "genre": "General Epistles", "order": 76},
    {"code": "1JN", "name": "1 John", "testament": "NT", "genre": "General Epistles", "order": 77},
    {"code": "2JN", "name": "2 John", "testament": "NT", "genre": "General Epistles", "order": 78},
    {"code": "3JN", "name": "3 John", "testament": "NT", "genre": "General Epistles", "order": 79},
    {"code": "JUD", "name": "Jude", "testament": "NT", "genre": "General Epistles", "order": 80},
    {"code": "REV", "name": "Revelation", "testament": "NT", "genre": "Apocalypse", "order": 81}
]
...
def main():
    ...
    print("Generating Chapter Centroids and Cross-Reference Map for Greek Septuagint & NT (LXX)...")

    verse_index_path = 'data/output/verse_index_lxx.json'
    wordmap_path = 'data/output/wordmap_2d_lxx.json'
    output_path = 'data/output/chaptermap_2d_lxx.json'
    ...
    print(f"Discovered {total_chapters} chapters across {len(BIBLE_BOOKS)} LXX books.")
    ...
    print("Packaging compact chaptermap_2d_lxx.json...")
    christ_vec = None
    ...
    print(f"Successfully generated {len(chapters_output)} LXX chapters in {elapsed:.2f}s!")
