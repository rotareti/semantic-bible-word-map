...
3. **Continuous Vector Training**: Using Gensim's Word2Vec Skip-gram architecture with negative sampling, the system trained 100-dimensional dense semantic vectors. A sliding window of 5 words captured immediate collocations, grammatical dependencies, and recurring thematic phrases throughout the canon.
